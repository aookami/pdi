...
% gera o circulo utilizando uma mascara gausiana de sigma "largura da
% imagem"/10, o que faz com que o raio do circulo seja igual a largura/20
%Transforma a mascara, entao para uma mascara logica, onde o valor será true onde
%a mascara tiver valor igual a um décimo do maior pixel da mascara. entao a
%imagem é multiplicada ponto a ponto pela mascara, deixando apenas os
%valores que se encontram dentro do circulo diferentes de zero